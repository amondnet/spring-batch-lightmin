...
public class JobControllerTest {
    ...
    public void enrichJobExecutionTest() {
        ...
        executions.add(this.createStepExecution());
        this.jobController.enrichJobExecution(model, executions);
    ...
    public void enrichJobInstanceModelTest() {
        when(this.jobServerService.getJobExecutionPage(anyLong(), any(LightminClientApplication.class))).thenReturn(this.createJobExecutionPage());
        ...
        this.jobController.enrichJobInstanceModel(model, jobInstance, this.lightminClientApplication);
    ...
    public void init() {
        ...
        this.jobController = new JobController(this.jobServerService, this.registrationBean);
    }
